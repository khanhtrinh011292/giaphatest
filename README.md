<p align="center">
  <img src="https://raw.githubusercontent.com/khanhtrinh011292/giaphaonline/main/public/icon.png" alt="Quản Lý Gia Phả Việt Nam Icon" width="100" height="100" style="border-radius: 22%; border: 0.5px solid rgba(0,0,0,0.1);" />
</p>

# Quản Lý Gia Phả Việt Nam
...
> **Tác giả:** [Phạm Khánh Trình](https://github.com/khanhtrinh011292) — [khanhtrinh011292/giaphaonline](https://github.com/khanhtrinh011292/giaphaonline)
...
- Demo: [giaphaonline.vercel.app](https://giaphaonline.vercel.app)
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fkhanhtrinh011292%2Fgiaphaonline&env=SITE_NAME,NEXT_PUBLIC_SUPABASE_URL,NEXT_PUBLIC_SUPABASE_PUBLISHABLE_DEFAULT_KEY)
...
3. Ở mục **Site URL**, điền URL chính của ứng dụng, ví dụ:
   - Vercel: `https://giaphaonline.vercel.app`
   - Máy cá nhân: `http://localhost:3000`
4. Ở mục **Redirect URLs**, nhấn **Add URL** và thêm:
   - `https://giaphaonline.vercel.app/**`
   - `http://localhost:3000/**` (nếu chạy local)
5. Nhấn **Save** và thử lại.

> **Lưu ý:** Thay `giaphaonline.vercel.app` bằng domain thực tế của bạn. Nếu dùng domain tùy chỉnh, hãy thêm cả domain đó vào danh sách.
...
Repository: [khanhtrinh011292/giaphaonline](https://github.com/khanhtrinh011292/giaphaonline)
...
- **Demo công khai:** Trang demo sử dụng dữ liệu mẫu hư cấu, không chứa thông tin của người thật. Không nên nhập thông tin cá nhân thật vào trang demo.
...
*Phát triển bởi [Phạm Khánh Trình](https://github.com/khanhtrinh011292)*
